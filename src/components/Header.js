...
const handleMenu = () =>{
  ...
  return (
    <div id="homepage">
      {/* Navbar */}
      <nav
        className="navbar navbar-expand-lg navbar-dark bg-dark px-md-4 px-lg-5 px-0"
        style={{
          position: "fixed",
          top: 0,
          width: "100%",
      ...
      >
        <a className="navbar-brand" href="#homepage">
          <div className="d-flex gap-3 align-items-center ps-sm-5 ps-2 logo">
        ...
        <button
          className="navbar-toggler me-sm-5 me-1 border-0"
          type="button"
        ...
        <div className={`collapse navbar-collapse ul-bg ${isMenuOpen ? "show" : ""}`} id="navbarContent">
          <ul className="navbar-nav me-auto ms-lg-5 ms-0 gap-lg-1 color-white ul-menu ps-sm-5 ps-0">
            ...
            <li className="nav-item dropdown">
              ...
              >
                ...
                <li><a className="dropdown-item text-white" href="#home">Something else here</a></li>
                 ...
                 <a className="nav-link" href="#members" onClick={handleMenu}  >
                    Members 
                   </a>
                 </li>
                 <li className="nav-item">
                   <a className="nav-link" href="#blog"  onClick={handleMenu}>
                     Blog                    
                    </a>                 
                  </li>                
                   <li className="nav-item">
                  <a className="nav-link" href="#pages"  onClick={handleMenu}>
                  Pages 
                  </a> 
                  </li>                 
                  <li className="nav-item">
          ...
          <div className="d-flex align-items-md-center px-sm-5 pe-md-5 ps-sm-3 ps-0 ms-sm-5 ms-3 bottom-menu">
            <a
              href="#contact"
            ...
            <a href="#home" className="text-white mx-2"  onClick={handleMenu}>
              <img src={avatar} alt="avatar" />
            </a>
            <a href="#contact"  onClick={handleMenu}>
              <button
                className="btn text-white border px-lg-2 py-md-1 px-2 rounded-5 ms-0 mx-lg-2 addproperty"
